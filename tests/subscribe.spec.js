...
test.describe('MyOTT Subscription Flow E2E Test', () => {
  test('should complete passwordless subscription and unsubscription', async ({ page }) => {
    const isProduction = !!process.env.BASE_URL.match(/www\.trade-tariff\.service\.gov\.uk/);
    ...
    const skipPasswordlessVerification = process.env.SKIP_PASSWORDLESS_VERIFICATION === 'true';
